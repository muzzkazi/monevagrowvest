      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <Tabs value={currentStep} className="w-full">
          ...
          <TabsList className="grid w-full grid-cols-3 mb-8">
            ...
            return <TabsTrigger key={step.id} value={step.id} disabled={!isAccessible} className={`flex items-center gap-2 py-3 relative ${!isAccessible ? 'opacity-50 cursor-not-allowed' : ''} ${step.completed ? 'text-green-600' : ''}`}>
