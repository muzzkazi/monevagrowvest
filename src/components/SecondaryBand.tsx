...
const SecondaryBand = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-blue-900/70 via-blue-800/50 to-blue-900/70 backdrop-blur-md text-white pt-4 pb-2 w-full z-20 overflow-hidden flex flex-col justify-center relative border-b border-blue-400/20">
      {/* Controls Row */}
