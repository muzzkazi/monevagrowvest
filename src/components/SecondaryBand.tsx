...
const SecondaryBand = () => {
  ...
  return (
    <div className="bg-slate-900/50 backdrop-blur-md text-white pt-4 pb-2 w-full z-20 overflow-hidden flex flex-col justify-center relative border-b border-white/5">
      {/* Controls Row */}
