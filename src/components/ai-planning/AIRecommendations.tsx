        ...
        <CardContent>
          <div className="grid md:grid-cols-3 gap-4 mb-6">
              <div className="text-center">
                <h4 className="text-4xl font-bold font-mono text-financial-accent tracking-tight">{formatCurrencyInCard(totalMonthlySIP)}</h4>
                <p className="text-sm text-muted-foreground">
                  {planningMode === "goals" ? "Monthly SIP Required" : "Monthly SIP Amount"}
                </p>
              </div>
              <div className="text-center">
                <h4 className="text-4xl font-bold font-mono text-financial-accent tracking-tight">{formatCurrencyInCard(totalTargetAmount)}</h4>
                <p className="text-sm text-muted-foreground">
                  {planningMode === "goals" ? "Total Target Amount" : "Projected Portfolio Value"}
                </p>
              </div>
              <div className="text-center">
                <h4 className="text-4xl font-bold font-mono text-financial-accent tracking-tight">
