      ...
      <Tabs defaultValue="portfolio" className="space-y-8">
        <TabsList className="grid w-full grid-cols-3 max-w-2xl mx-auto">
          <TabsTrigger value="portfolio" className="flex items-center gap-2">
            ...
            <span className="hidden sm:inline">Debt Portfolio</span>
            <span className="sm:hidden">Portfolio</span>
          </TabsTrigger>
          <TabsTrigger value="strategy" className="flex items-center gap-2">
            <TrendingDown className="w-4 h-4" />
            <span className="hidden sm:inline">Payment Strategy</span>
        ...
        <TabsContent value="strategy" className="animate-fade-in">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Compare snowball vs avalanche methods and see which saves you more
              </CardDescription>
            </CardHeader>
            <CardContent>
              <PaymentStrategy 
